    ...
    <div class="content-box">
        ...
        <form method="POST" id="healthForm">
            ...
            <div class="input-group">
                ...
                <input type="number" step="0.1" name="weight" placeholder="0.0" required style="width: 110px;">
            </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="?delete=<?= $date ?>" class="btn-delete" onclick="return confirm('Löschen?')">🗑️</a></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
<footer>
    <p><strong>Gesundheitstracker</strong> | Lizenziert unter <a href="https://www.gnu.org/licenses/agpl-3.0.de.html" target="_blank">AGPL-3.0</a> | Source: <a href="https://github.com/herr-nm/Privat_Gesundheit" target="_blank">GitHub</a></p>
</footer>
